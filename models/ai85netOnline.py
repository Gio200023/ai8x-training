...
class AI85Net5Online(nn.Module):
    """
    5-Layer CNN that uses max parameters in AI84
    """
    def __init__(self, num_classes=27, num_channels=1, dimensions=(28, 28),
...
def ai85net5online(pretrained=False, **kwargs):
    """
    Constructs a AI85Net5 model.
    """
    assert not pretrained
    return AI85Net5Online(**kwargs)
